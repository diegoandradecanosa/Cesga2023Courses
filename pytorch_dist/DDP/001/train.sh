...
torchrun --nproc_per_node=$GPUS_PER_NODE --nnodes $SLURM_JOB_NUM_NODES --node_rank $SLURM_NODEID --rdzv_id=$SLURM_JOB_ID --rdzv_endpoint=$MASTER:12373 --master_addr $MASTER mnist_classify_ddp.py --epochs=2
